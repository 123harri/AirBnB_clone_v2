...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        """Creates an instance of any class with specified parameters."""
        try:
            if not args:
            ...
            for arg in arg_parts[1:]:
                ...
                arg_split = arg.split("=")
                # Evaluate the value and handle if it's a string
